...
CFG = os.path.join(BASE, "DM-CNN", "cfg", "inference_config_binary_mpid_3.cfg")
JOBDIR = os.path.join(BASE, "DM-CNN")
JOBFILE = "jobs/inference_dmcnn_3.job"
...
# OUT_DIR = os.path.join(BASE, "outputs", "inference", "run3_samples_mpid")
OUT_DIR = os.path.join(BASE, "outputs", "inference", "run3_data_mpid")
