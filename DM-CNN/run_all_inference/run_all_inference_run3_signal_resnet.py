...
CFG = os.path.join(BASE, "DM-CNN", "cfg", "inference_config_binary_resnet_4.cfg")
JOBDIR = os.path.join(BASE, "DM-CNN")
JOBFILE = "inference_resnet_4.job"
...
OUT_DIR = os.path.join(BASE, "outputs", "inference", "run3_signal_resnet34_gn")
