...
# NET VERSION FOR BINARY CLASSIFICATION
...
class MPID(nn.Module):
    ...
    def __init__(self, dropout=0.5, num_classes=2, eps=1e-05, running_stats=False):
        ...
        self.features = nn.Sequential(
            ...
            # layer 3
            nn.Conv2d(
                in_channels=96, out_channels=128, kernel_size=3, stride=1, padding=1
            ),
            nn.ReLU(),
            ...
            # layer 4
            nn.Conv2d(
                in_channels=128, out_channels=160, kernel_size=3, stride=1, padding=1
            ),
            nn.ReLU(),
            ...
            # layer 5
            nn.Conv2d(
                in_channels=160, out_channels=192, kernel_size=3, stride=1, padding=1
            ),
            nn.ReLU(),
