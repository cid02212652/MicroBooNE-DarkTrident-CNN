...
def TrainCNN():
    ...
    fout = open(
        output_dir
        + "{}_{}_training_metrics_{}.csv".format(model_name, resnet_norm, timestr()),
        "w",
    )
    ...
    CNN_weights = (
        weights_dir + "{}_{}_model_{}_epoch_{}_batch_id_{}_labels_{}_step_{}.pwf"
    )
    ...
    test_data = mpid_data_binary.MPID_Dataset(
        test_file, "image2d_image2d_binary_tree", train_device, plane=cfg.plane
    )
