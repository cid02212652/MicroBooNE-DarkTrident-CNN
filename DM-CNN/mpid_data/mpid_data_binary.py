...
class MPID_Dataset(Dataset):
    def __init__(
        self, input_file, image_tree, device, plane=0, augment=False, verbose=False
    ):
        self.plane = plane
    ...
    def __getitem__(self, ENTRY):
        ...
        self.this_image_cpp_object = (
            self.particle_image_chain.image2d_image2d_binary_branch
        )
        ...
        # Return info
        self.event_info = [
            self.this_image_cpp_object.run(),
            self.this_image_cpp_object.subrun(),
            self.this_image_cpp_object.event(),
        ]
